...
#define BLE_UUID_NUS_ACC_X_CHARACTERISTIC  0X0004                    //ACC
#define BLE_UUID_NUS_ACC_Y_CHARACTERISTIC  0X0005
#define BLE_UUID_NUS_ACC_Z_CHARACTERISTIC  0X0006

#define BLE_UUID_NUS_GYRO_X_CHARACTERISTIC  0X0007                   //GYRO
#define BLE_UUID_NUS_GYRO_Y_CHARACTERISTIC  0X0008
#define BLE_UUID_NUS_GYRO_Z_CHARACTERISTIC  0X0009
...
#define BLE_NUS_MAX_ACC_X_CHAR_LEN      20                           //ACC_X
#define BLE_NUS_MAX_ACC_Y_CHAR_LEN      20                           //ACC_Y
#define BLE_NUS_MAX_ACC_Z_CHAR_LEN      20                           //ACC_Z

#define BLE_NUS_MAX_GYRO_X_CHAR_LEN     20                           //GYRO_X
#define BLE_NUS_MAX_GYRO_Y_CHAR_LEN     20                           //GYRO_Y
#define BLE_NUS_MAX_GYRO_Z_CHAR_LEN     20                           //GYRO_Z
 ...
 */
uint32_t ble_nus_send_acc(ble_nus_t * p_nus, uint8_t * string, uint16_t length);


uint32_t ble_nus_send_gyro(ble_nus_t * p_nus, uint8_t * string, uint16_t length);
